            ...
            <legend>Submit Issue</legend>
                <ul class="form-flex-outer">
                    ...
                    <li>
                        ...
                        <input type="text" name="subject" id="subject" placeholder="Add Subject to the Issue"  required="required">
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="issuer" id="issuer" placeholder="Issuers Name"  required="required">
                    </li>
                    <li>
                        <label for="issuer_role">Issuer Role</label>
                        <input type="text" name="issuer_role" id="issuer_role" placeholder="Issuers Role"  required="required">
                    </li>
                    <li>
