            ...
            <legend>Vendor Details</legend>
                <ul class="form-flex-outer">
                	<li>
                        ...
                        <input type="text" id="name" name="name" value="<?php echo $row_vendor['contact_name']; ?>" required="required">
                    </li>
                    <li>
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" value="<?php echo $row_vendor['email']; ?>" required="required">
                    </li>
                    <li>
                        <label for="phone">Phone No.</label>
                        <input type="tel" id="phone" name="phone" value="<?php echo $row_vendor['phone_no']; ?>" required="required">
                    </li>
                    <li>
