<?php
    ...
    if(isset($_GET['edit_review'])){
        $review_id = mysqli_real_escape_string($conn, $_GET['edit_review']);
            ...
            <legend>Review Details</legend>
                <ul class="form-flex-outer">
                	<li>
                        ...
                        <input type="text" id="contract-num" name="contract-num" value="<?php echo $row_review['contract_no']; ?>" required="required">
                    </li>
                    <li>
                        <label for="reviewer">Reviewer</label>
                        <input type="text" id="reviewer" name="reviewer" value="<?php echo $row_review['reviewer_name']; ?>" required="required">
                    </li>
                    <li>
