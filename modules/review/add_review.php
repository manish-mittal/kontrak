            ...
            <legend>Review Details</legend>
                <ul class="form-flex-outer">
                	<li>
                        ...
                        <input type="text" id="contract-num" name="contract-num" placeholder="Enter contract reference number here" required="required">
                    </li>
                    <li>
                        <label for="reviewer">Reviewer</label>
                        <input type="text" id="reviewer" name="reviewer" placeholder="Enter reviewer name here" required="required">
                    </li>
                    <li>
                        <label for="datepicker">Review Date</label>
                        <input type="text" name="review_date" id="datepicker" required="required">
                    </li>
                    <li>
