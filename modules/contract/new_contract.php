            ...
            <legend>Contract Details</legend>
                <ul class="form-flex-outer">
                    ...
                    <li>
                        ...
                        <input type="number" step="0.1" name="life" id="life" required="required">
                    </li>
                    <li>
                        <label for="supplier">Name of Supplier</label>
                        <input type="text" name="supplier" id="supplier" placeholder="Enter Supplier's Name here" required="required">
                    </li>
                    <li>
        ...
        <fieldset>
            <legend>Payment Details</legend>
                <ul class="form-flex-outer">
                    ...
                    <li>
                        <label for="spend">Annual Spend (INR)</label>
                        <input type="number" step="0.01" name="spend" id="spend" placeholder="Total Spend Annually (upto 2 decimal places)"  required="required">
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" id="status" name="status" placeholder="Enter status of payment here" required="required">
                    </li>
                </ul>
        </fieldset>
         <fieldset>
            <legend>Vendor Details</legend>
                <ul class="form-flex-outer">
                    <li>
                        ...
                        <input type="text" id="vendor_name" name="vendor_name" placeholder="Enter Vendor Name" required="required">
                    </li>
                    <li>
                        <label for="vendor_email">Email</label>
                        <input type="email" id="vendor_email" name="vendor_email" placeholder="Enter Vendor Email" required="required">
                    </li>
                    <li>
                        <label for="vendor_contact">Contact Number</label>
                        <input type="tel" id="vendor_contact" name="vendor_contact" placeholder="Enter Vendor Contact number" required="required">
                    </li>
                </ul>
        </fieldset>
        <fieldset>
            <legend>Service Delivery Manager</legend>
                <ul class="form-flex-outer">
                    <li>
                        ...
                        <input type="text" id="sdm_name" name="sdm_name" placeholder="Enter SDM Name" required="required">
                    </li>
                    <li>
                        <label for="sdm_email">Email</label>
                        <input type="email" id="sdm_email" name="sdm_email" placeholder="Enter SDM Email" required="required">
                    </li>
                    <li>
                        <label for="sdm_contact">Contact</label>
                        <input type="tel" id="sdm_contact" name="sdm_contact" placeholder="Enter Contact number" required="required">
                    </li>
                    <li>
            ...
            <legend>Contract Expiration and Notices</legend>
                <ul class="form-flex-outer">
                    <li>
                        ...
                        <input type="text" name="expiration_date" id="e-datepicker" required="required">
                    </li>
                    <li>
                        <label for="renewal_provision">Renewal Provision</label>
                        <select name="renewal_provision" id="renewal_provision" required="required">
                    ...
                    <li>
                        ...
                        <input type="text" id="assignment_provision" name="assignment_provision" placeholder="Assignment Provision" required="required">
                    </li>
                    <li>
    ...
    {	  
	   //Text data variables
	    ...
	    if($result_contract){
            ...
            echo"<script>alert('New Contract Details Added.')</script>";
